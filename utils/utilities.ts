...
export const constructDownloadUrl = (bucketFileId: string) => {
  ...
  return `${config.public.appwriteEndpoint}/storage/buckets/${config.public.appwriteBucket}/files/${bucketFileId}/download?project=${config.public.appwriteProject}`;
};
